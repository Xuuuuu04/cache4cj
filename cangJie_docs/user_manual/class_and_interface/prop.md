...
getter 和 setter 的实现中可以和函数体一样包含声明和表达式，与函数体的规则一样，详见[函数体](../function/define_functions.html#%E5%87%BD%E6%95%B0%E4%BD%93)章节。
...
属性分为实例成员属性和静态成员属性。成员属性的使用和成员变量的使用方式一样，详见[成员变量](./class.html#class-%E6%88%90%E5%91%98%E5%8F%98%E9%87%8F)章节。
